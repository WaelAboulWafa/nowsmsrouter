...
//////////////////tyourl el ganna MTN  /////////////////////////////
String shortcode5="2944";
String IP5="94.249.127.98";
int Port5=37001;
String success5="OK";
/////////////////////////////////////////////// ////////////////////////////////////////
...
*/
 ...
 public MainTh()
 {
   ...
   //list_to_fetch = "and shortcode in ('" + shortcode2 +  "','" + shortcode3 + "','" + shortcode4 +  "')"; 
	 ...
	 list_to_fetch = "and shortcode in ('" + shortcode2 +  "','" + shortcode3 + "','" + shortcode4 + "','" + shortcode5 +  "')"; 
  
  //    list_to_fetch = "and shortcode in ('" + shortcode2 +  "','" + shortcode3 + "','" + shortcode4 + "','" + shortcode5 + "','" + shortcode6 +  "')";
