       ...
       public String Generate_HTTP_Request()
       {
        ...
        String therequest ="";
         ...
         //shortcode 1,2 (nradio service)
    	   if( shortcode.equalsIgnoreCase(Opconnector.shortcode1)  ||   shortcode.equalsIgnoreCase(Opconnector.shortcode2)   )
    	   {
...
/*
         ...
         //shortcode 3 (xxx service)
    	   if(shortcode.equalsIgnoreCase(Opconnector.shortcode3) )
    	   {
